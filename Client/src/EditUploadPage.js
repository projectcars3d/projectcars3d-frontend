...
const history = useHistory()
    ...
    async function editProduct(productIdToEdit){
        let productName = document.getElementById("productName").value;
        let productDescription = document.getElementById("productDescription").value;
        let productPartNumber = document.getElementById("productPartNumber").value;
        ...
        let productBedTemp = document.getElementById("productBedTemp").value; 
            ...
            let file = [];
            formData.append('_id', products._id);
            ...
            fetch("/productsRouters/edit_products", {
                method: 'Post',
  ...
  return (
    <div>
        ...
        <div id='signInContainer'>
            ...
            <div className='signInInputsContainer'>
                <label style={{display: "flex"}}>Upload Your 3D Files &nbsp;<InfoPopup text="Only 1 .stl/.obj file or 1 .zip file - Max 50Mb" /> </label>
                   ...
                   {(() => {
                        ...
                        if(fitCarsArr.length > 0){
                            return fitCarsArr.map((car, i) => {
                                if(car.selectedFromYear === null && car.selectedToYear === 0){
            ...
            <div className='signInInputsContainer' id='createAnAccountCtn'>
                <button id='createAccountBtn' className='allButtons' onClick={() => editProduct(products._id)} disabled={isSubmitDisabled}>Update</button>
                <Link to={"/my_uploads"}>
